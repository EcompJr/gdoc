...
<div id="wrapper">  
    <div id="page-wrapper">
      <div id="page-inner">
        <div class="row">
          <div class="col-md-10">
            <h2 class="text-primary text-center">Cadastro de Usuários Administradores</h2>
        ...
        <form id="formCadastro" data-toggle="validator" role="form" data-delay="350">
          ...
          <div class="form-group">        
              <button style="float: left" class="btn btn-warning" type="reset" name="resetar">Resetar</button>
